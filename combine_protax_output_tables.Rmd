...
```{r}
# rm(list = ls())
pathtoprotaxout <- "~/src/screenforbio-mbc-ailaoshan" # screenforbio folder
setwd(pathtoprotaxout)
```

```{r combine weighted swarm_12S}
pathtoprotaxout <- "~/src/screenforbio-mbc-ailaoshan" # screenforbio folder
pathtoprotax2 <- "w_protaxout_swarm_20190624_12S" # 
pathtoprotax_file <- "12S_otu_table_swarm_lulu_20190624.fas." # fasta file name
...
pathtoprotax2 <- "protaxout_swarm_20190624_12S"
...
Create a folder for all the outputs
```{bash}
cd ~/src/screenforbio-mbc-ailaoshan
ls
mkdir protax_outputs_12S_16S_weighted_unweighted_20190624
ls
mv w_protaxout_swarm_20190624*/ protax_outputs_12S_16S_weighted_unweighted_20190624/
mv protaxout_swarm_20190624*/ protax_outputs_12S_16S_weighted_unweighted_20190624/
ls
ls protax_outputs_12S_16S_weighted_unweighted_20190624
```

```{r export tables}
pathtoprotaxout <- "~/src/screenforbio-mbc-ailaoshan"
pathtoprotax2 <- "protax_outputs_12S_16S_weighted_unweighted_20190624"

write_tsv(protaxout_swarm_12S_weighted_unweighted, file.path(pathtoprotaxout, paste0(pathtoprotax2),"protaxout_swarm_12S_weighted_unweighted_20190624.tsv"))

write_tsv(protaxout_swarm_16S_weighted_unweighted, file.path(pathtoprotaxout, paste0(pathtoprotax2),"protaxout_swarm_16S_weighted_unweighted_20190624.tsv"))
```
