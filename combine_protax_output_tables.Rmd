...
pathtoprotax2 <- "w_protaxout_Brazil_12S_20190727_12S" # 
pathtoprotax_file <- "OTU_fasta_riaz." # fasta file name
...
pathtoprotax2 <- "protaxout_Lyngaard_20190722_12S"
pathtoprotax_file <- "OTU_fasta_riaz.fasta."
# setwd(pathtoprotaxout)
...
pathtoprotaxout <- "~/src/screenforbio-mbc-ailaoshan/"
pathtoprotax2 <- "w_protaxout_Brazil_16S_20190727_16S"
pathtoprotax_file <- "16Smam_OTUs."
...
pathtoprotaxout <- "~/src/screenforbio-mbc-ailaoshan"
pathtoprotax2 <- "protaxout_Lyngaard_20190722_16S"
pathtoprotax_file <- "16Smam_OTUs."
...
pathtoprotaxout <- "~/src/screenforbio-mbc-ailaoshan"
pathtoprotax2 <- "w_protaxout_Brazil_16S_20190727_16S"
write_tsv(w_protaxout_swarm_12S_all, file.path(pathtoprotaxout, paste0(pathtoprotax2),"w_protaxout_Brazil_12S_20190727_12S.tsv"))
write_tsv(w_protaxout_swarm_16S_all, file.path(pathtoprotaxout, paste0(pathtoprotax2),"w_protaxout_Brazil_16S_20190727_16S.tsv"))
```
